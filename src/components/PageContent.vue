  ...
  methods: {
    onCounter: function (item, count) {
      if (this.itemsSelected.length === 0 && count > 0) {
        ...
        console.log("itemSelected-EmptyList: " + this.itemsSelected + " \n");
      } else {
        ...
        for (let i = 0; i < this.itemsSelected.length; i++) {
          ...
          if (item_name === item.name && count > 0) {
            ...
            console.log("itemSelected-CASE 1: " + this.itemsSelected + " \n");
            found = true;
          } else if (item_name === item.name && count === 0) {
            // Next, item_name is the same as item.name and the count is 0, remove it from itemsSelected.
            this.itemsSelected.splice(this.itemsSelected.indexOf(curr_item), 1);
            found = true;
            console.log("itemSelected-CASE 2: " + this.itemsSelected + " \n");
          } else {
            console.log("Error");
          }
        }
